...
from duplicate_folder_structure_detector.cli import main
from duplicate_folder_structure_detector.core import PROJECT, analyze, render_json, render_markdown
